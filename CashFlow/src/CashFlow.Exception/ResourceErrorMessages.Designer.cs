...
namespace CashFlow.Exception {
    ...
    public class ResourceErrorMessages {
        ...
        /// <summary>
        ///   Looks up a localized string similar to The password must contain at least 8 characters, one uppercase letter, one lowercase letter, one number, and one special character..
        /// </summary>
